...
export function getWeatherAdvice(temperature, isRaining) {
  if (temperature >= 35) {
    ...
    if (!isRaining) return "Great weather for hiking - don't forget sunscreen";
    return "Warm but rainy - consider indoor activities";
  } else if (temperature >= 15) {
    if (!isRaining) return "Perfect hiking weather - enjoy the trails";
    return "Cool and rainy - bring waterproof gear if hiking";
  } else if (temperature >= 5) {
    if (!isRaining) return "Chilly - wear layers for your hike";
